  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .btn{
      ...
      padding:6px 10px;font-weight:600;box-shadow:0 1px 4px rgba(0,0,0,.6);font-size:13px;line-height:1;min-height:32px;
      white-space:nowrap;
    }
    ...
    .row{
      ...
      gap:8px;align-items:center;border-bottom:1px solid var(--border);padding:6px 0;
    }
    .row > *{ min-width:0; }
    ...
    input,select{
      height:34px;border-radius:8px;border:1px solid var(--border);background:#222;color:#fff;padding:0 10px;outline:none;width:100%;
    }
    ...
    /* форма создания: один ряд + кнопка в том же ряду (как было) */
    .new-grid{
      display:grid;
    ...
    .filter{height:32px; border-radius:8px; border:1px solid var(--border); background:#222; color:#fff; padding:0 10px; width:260px}
    ...
    <div class="panel" style="margin-top:14px">
      <div class="toolbar">
        ...
        <div class="row header" style="border-bottom:none;">
          <div>ID</div><div>Логін</div><div>Імʼя</div>
        </div>
...
function userRow(u){
  ...
  row.append(id, inUser, inName, selRole, infoRO, actions);
  return row;
}
